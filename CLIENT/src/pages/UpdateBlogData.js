...
const UpdateBlogData = () => {
    ...
    return (
        <div className="w-full max-w-7xl px-4 my-12 py-6 border-neutral border-2 mx-auto">
                ...
                >
                    ...
                    <div className="form-control mt-4">
                        ...
                        {errors.postTitle?.type === "minLength" && (
                            <span className="label-text-alt text-red-600 font-medium ">
                                Post Title is very short &#40; min 20 characters
                                &#41;
                            </span>
                        )}
                        {errors.postTitle?.type === "maxLength" && (
                            <span className="label-text-alt text-red-600 font-medium ">
                                Post Title is too long &#40; max 300 characters
                                &#41;
                            </span>
                        )}
                    ...
                    <div className="form-control mt-4 ">
                        ...
                        <div className="" id="quill_form">
                            <QuillForm getQuillFormValue={getQuillFormValue} />
                        </div>
                    </div>
                    {/* submit button */}
